...
<div class="row">
	...
	<div class="col-sm-4">
		<div class="example">
			<div class="icon">
				<i class="wi wi-beafort-10"> </i>
			</div>
			<div class="class">wi-beafort-10</div>
		</div>
		<div class="example">
			<div class="icon">
				<i class="wi wi-beafort-11"> </i>
			</div>
			<div class="class">wi-beafort-11</div>
		</div>
		<div class="example">
			<div class="icon">
				<i class="wi wi-beafort-12"> </i>
			</div>
...
<div class="row">
	...
	<div class="col-sm-4">
		<div class="example">
			<div class="icon">
				<i class="wi wi-wind-default _240-deg"></i>
			</div>
			<div class="class">wi-wind-default _240-deg</div>
		</div>
		<div class="example">
			<div class="icon">
				<i class="wi wi-wind-default _255-deg"></i>
			</div>
		...
		<div class="example">
			<div class="icon">
				<i class="wi wi-wind-default _285-deg"></i>
			</div>
			<div class="class">wi-wind-default _285-deg</div>
		</div>
		<div class="example">
			<div class="icon">
				<i class="wi wi-wind-default _300-deg"></i>
			</div>
			<div class="class">wi-wind-default _300-deg</div>
		</div>
		<div class="example">
			<div class="icon">
				<i class="wi wi-wind-default _315-deg"></i>
			</div>
			<div class="class">wi-wind-default _315-deg</div>
		</div>
		<div class="example">
			<div class="icon">
				<i class="wi wi-wind-default _330-deg"></i>
			</div>
			<div class="class">wi-wind-default _330-deg</div>
		</div>
		<div class="example">
			<div class="icon">
				<i class="wi wi-wind-default _345-deg"></i>
			</div>
